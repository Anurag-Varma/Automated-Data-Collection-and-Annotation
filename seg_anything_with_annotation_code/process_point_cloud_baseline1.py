...
class pointCloud(object):
   ...
   def __init__(self): 
      ...
      # Attribute to store the center of the grids:
   ...
   def removePlaneSurface(self):
      ...
      for i in range(len(self.normals)):
         ...
         # if max_idx[0] == 2 and self.points[i, 2] <= 0.115:
         #if max_idx[0] == 0:
   ...
   def getIdealGraspingRegion(self):
      # Initializing the array used to store the grid centers corresponding to the ideal grasping region:
      self.ideal_grasping_region_grid_centers = []
      ...
      self.eta_threshold = 0.9*self.max_metric_value
      ...
      for i in range(0, self.grid_metric_values_occupied.shape[0]):
         if self.grid_metric_values_occupied[i] >= self.eta_threshold:
               ...
               self.ideal_grasping_region_grid_centers.append(self.grid_centers_occupied[i, :])
